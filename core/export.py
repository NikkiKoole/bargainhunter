"""Export a static build that needs no Python at all.
    ...
    python3 -m franimo.export            # writes repo root
    python3 -m core.export               # same
...
def pack(rows: list[dict]) -> dict:
    ...
    Franimo URLs are stored relative to urlPrefix; any other absolute URL is
    left intact so unpack() can mix sources.
    """
...
def main(argv=None) -> int:
    ...
    print(f"\ncheck it with:  python3 -m http.server -d {out} 8080")
    return 0
